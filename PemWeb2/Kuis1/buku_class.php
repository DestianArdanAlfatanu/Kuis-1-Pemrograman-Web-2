...
class buku
{
    ...
    public function insertData($judul, $pengarang, $tahun_terbit)
    {
        try {
            $stmt = $this->db->prepare("INSERT INTO buku(judul,pengarang,tahun_terbit) VALUES(:judul, :pengarang, :tahun_terbit)");
    ...
    public function updateData($id, $judul, $pengarang, $tahun_terbit)
    {
        try {
            $stmt = $this->db->prepare("UPDATE buku SET judul=:judul, pengarang=:pengarang, tahun_terbit=:tahun_terbit WHERE id=:id");
